...
def detect_offense(brd, valid_squares, comp_mark)
  valid_offense(prioritize(comp_squares(brd, comp_mark)), valid_squares)
end
...
def detect_defense(brd, valid_squares, player_mark)
  valid_defense(prioritize(player_squares(brd, player_mark)), valid_squares)
end

def select_five(brd, valid_squares, player_mark)
  5 if (valid_squares.include?(5)) && (!player_squares(brd, player_mark).empty?)
end
###########################################
# Output
###########################################
...
def computer_places_piece!(brd, valid_squares, comp_mark, opponent_mark)
  square = if detect_offense(brd, valid_squares, comp_mark)
             detect_offense(brd, valid_squares, comp_mark).sample
           elsif detect_defense(brd, valid_squares, opponent_mark)
             detect_defense(brd, valid_squares, opponent_mark).sample
           elsif select_five(brd, valid_squares, opponent_mark)
             select_five(brd, valid_squares, opponent_mark)
           else
             valid_squares.sample
           end
